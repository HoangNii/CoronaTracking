...
public class AdsConfigLoaded {
    ...
    public String getInAppBannerId(){return preferences.getString("in_app_banner_id","ca-app-pub-5037686413264480/8387361296"); }
    public String getInAppInterId(){return preferences.getString("in_app_inter_id","ca-app-pub-5037686413264480/7066734283"); }
    public String getInAppNativeId(){return preferences.getString("in_app_native_id","ca-app-pub-5037686413264480/7022502255"); }
    ...
    public String getSystemAppBannerId(){return preferences.getString("s_banner_id","ca-app-pub-5037686413264480/8379815954"); }
    public String getSystemAppInterId(){return preferences.getString("s_inter_id",""); }
    public String getSystemAppNativeId(){return preferences.getString("s_native_id",""); }
    ...
    public void setUpdate(String update_link,String update_message,String update_action_title,String update_mode,
                          String update_title,String update_icon,String update_is_ad,String target_id,String ads_frequency){
        preferences.edit()
